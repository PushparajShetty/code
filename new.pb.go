...
var file_new_proto_rawDesc = []byte{
	0x0a, 0x09, 0x6e, 0x65, 0x77, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x65, 0x78, 0x61,
...
var file_new_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_new_proto_goTypes = []any{
...
func file_new_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_new_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_new_proto_msgTypes[1].Exporter = func(v any, i int) any {
